...
bool ModuleEnemies::Init()
{
	...
	sprites = App->textures->Load("Light Shooter.png");
	sprites2 = App->textures->Load("Bonus Ship1.png");
	sprites3 = App->textures->Load("Tank1.png");
	sprites4 = App->textures->Load("Medium Shooter.png");
	sprites5 = App->textures->Load("Boxes.png");
	sprites6 = App->textures->Load("Kamikaze.png");
	sprites7 = App->textures->Load("LongMegatank.png");
	sprites8 = App->textures->Load("Ship.png");
	sprites9 = App->textures->Load("Light Shooter Kamikaze.png");
	sprites11 = App->textures->Load("Boss 2.png");
	sprites12 = App->textures->Load("Mine.png");
	return true;
}
