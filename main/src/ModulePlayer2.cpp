...
bool ModulePlayer2::Init()
{
	...
	graphics = App->textures->Load("Player2.png");
	graphics2 = App->textures->Load("graphics2.png");
	...
	score = 0;
	font_score = App->fonts->Load("Font.png", "> ?@ABCDEFGHIJKLMNOPQRSTUVWXYZ!�?_^#$%&'()x+.-,;tpsczpc/0123456789:", 3);
...
update_status ModulePlayer2::Update()
{
	...
	if (propeller)
	{
		...
		// Draw UI (score) --------------------------------------
		snprintf(score_text, 20, "2UP", score);
		snprintf(scoret, 20, "%7d", score);
	}
