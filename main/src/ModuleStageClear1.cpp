...
bool ModuleStageClear1::Init()
{
	...
	StageClear1 = App->textures->Load("Winningscreen.png");
	return true;
}
...
update_status ModuleStageClear1::Update()
{
	...
	snprintf(text, 60, "CONGRATULATIONS!YOU BEAT");
	snprintf(text1, 60, "OUR GAME!THANK YOU FOR");
	snprintf(text2, 60, "PLAYING IT,YOUR HIGHEST");
	snprintf(text3, 60, "SCORE WAS:");
